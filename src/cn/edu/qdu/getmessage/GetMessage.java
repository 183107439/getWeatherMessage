...
public class GetMessage {
	...
	public static void main(String[] args) {
		GetMessage we=new GetMessage();
		we.getCitys("海南");
		we.getProvinces();
		we.getWeather("海口");
		for (String string : we.weatherMessage) {
			System.out.println(string);
		}
		System.out.println(we.weatherMessage.get(2));
		System.out.println(we.weatherMessage.get(1));
	}
	...
	public void getCitys(String provinceName){
		OutputStreamWriter out=null;
		try {
			//通过URL上代调用openConnection()方法创建连接对象
